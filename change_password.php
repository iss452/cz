					...
					if ($result['passwordHash'] == md5($_POST['password']. $result['passwordSalt']))
					{
						...
						if($sql)
						{
							echo "<p class = \"center\">Congratulations! You have successfully changed your password.</p>";
														 $message = "   <p style = \"text-align:center\"><a href=\"view_member_list.php\">View the Zodiac Member List</a> | ";
													   $message .= "   <a href=\"view_member_webpage.php?id=".
															 $_SESSION['id']."\">View my Zodiac Profile</a> | ";
													   $message .= "   <a href=\"member_update.php\">Create/Update My Zodiac Profile</a> | ";
...
else
{
     ...
     $message.="<p>Please <a href='fac_login.html'>log in</a> to perform this action.</p>\n";
}
